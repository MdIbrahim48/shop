				...
				<div class="product">
					<div class="row gutter-40">
						...
						<div class="col-md-5 product-desc">
							...
							============================================= -->
							<form action="{{route('add.cart')}}" class="cart mb-0 d-flex justify-content-between align-items-center" method="POST"enctype='multipart/form-data'>
								@csrf
			...
			<div class="w-100">
				...
				<div class="owl-carousel product-carousel carousel-widget" data-margin="30" data-pagi="false" data-autoplay="5000" data-items-xs="1" data-items-md="2" data-items-lg="3" data-items-xl="4">
					...
					{{-- <div class="oc-item">
						<div class="product">
							<div class="product-image">
								<a href="#"><img src="{{asset('images/products/thumbnail/'.$product->thumbnail)}}" alt="Checked Short Dress"></a>
								<a href="#"><img src="{{asset('images/products/featured_image/'.$product->featured_image)}}" alt="Checked Short Dress"></a>
								<div class="badge bg-success p-2">50% Off*</div>
								<div class="bg-overlay">
									<div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
										<a href="#" class="btn btn-dark me-2"><i class="icon-shopping-cart"></i></a>
					...
					<div class="oc-item">
						<div class="product">
							<div class="product-image">
								<a href="#"><img src="{{asset('frontend/images/shop/shoes/1-1.jpg')}}" alt="Dark Brown Boots"></a>
								<a href="#"><img src="{{asset('frontend/images/shop/shoes/1.jpg')}}" alt="Dark Brown Boots"></a>
								<div class="bg-overlay">
									<div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
										<a href="#" class="btn btn-dark me-2"><i class="icon-shopping-cart"></i></a>
										<a href="include/ajax/shop-item.html" class="btn btn-dark" data-lightbox="ajax"><i class="icon-line-expand"></i></a>
