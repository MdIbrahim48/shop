      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="card">
            ...
            <div class="card-body">
                <div class="row g-3">
                    <form action="{{route('districts.update',['district'=>$district->id])}}" method="POST" class="needs-validation" novalidate="">
                        @csrf
                        @method('PUT')
                        <div class="col-md-7">
                            <label class="form-label" for="validationCustom01">District name</label>
                            <input class="form-control @error('district_name') is-invalid @enderror" name="district_name" value="{{$district->district_name ?? old('district_name')}}" id="validationCustom01" type="text" placeholder="Enter District Name" required="">
                            @error('district_name')
