      ...
      <nav class="sidebar-main">
        ...
        <div id="sidebar-menu">
          <ul class="sidebar-links" id="simple-bar">
            ...
            <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="{{asset('backend_assets/starter-kit/index.html')}}" target="_blank"><i data-feather="anchor"></i><span>Starter kit</span></a></li>
